  ...
  return (
    <div className='flex flex-col w-3/5 mx-auto space-y-2'>
      ...
      <div className='flex gap-4 text-center justify-between'>
        <div className='items-center rounded-lg bg-white bg-opacity-5 w-full p-4 space-y-2'>
          ...
          <div className='flex'>
            <div className='items-center rounded-lg w-1/2'>
              ...
              <p className='text-gray-500 text-2xl'>{beforePriorityFee}</p>
            </div>
            <div className='items-center rounded-lg w-1/2'>
              <p className='text-gray-500'>Max Fee</p>
              <p className='text-gray-500 text-2xl'>{beforeMaxFee}</p>
            </div>
          </div>
        </div>
        <div className='items-center rounded-lg bg-white bg-opacity-5 w-full p-4 space-y-2'>
          ...
          <div className='flex'>
            <div className='items-center rounded-lg w-1/2'>
              <p className='text-gray-500'>Priority Fee</p>
              <p className='text-gray-500 text-2xl'>{laterPriorityFee}</p>
            </div>
            <div className='items-center rounded-lg w-1/2'>
              <p className='text-gray-500'>Max Fee</p>
              <p className='text-gray-500 text-2xl'>{laterMaxFee}</p>
            </div>
          </div>
        </div>
      </div>
