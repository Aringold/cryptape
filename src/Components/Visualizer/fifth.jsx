...
function Fifth() {
  ...
  return (
    <div className="h-max items-center md:p-6 py-6">
      ...
      <div className="bg-white mt-6 bg-opacity-5 md:w-5/6 w-full mx-auto p-4 rounded-lg space-y-6 grid md:grid-cols-5 grid-cols-2 items-end gap-6">
        <div className="space-y-2">
          <p className="text-white text-sm">Median Txs Per Block</p>
          <div className="bg-white bg-opacity-10 p-2 rounded-md">
